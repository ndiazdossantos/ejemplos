...
import com.noesencillito.lecturaEscritura.LecturaEscritura;
import java.io.File;
...
*/
     ...
     Lectura obxLec = new Lectura();
    LecturaEscritura obx1 = new LecturaEscritura();
    File f = new File("pruebanumeros.txt");
    obx1.escribirNumeros("pruebanumeros.txt");
    LinkedList <Integer> lista = obx1.lerNumeros(f);
       for(Integer v :lista)
            System.out.println("** "+v);
    }
